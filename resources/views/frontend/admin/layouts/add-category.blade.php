...
<body class="bg-gray-900 text-gray-100 font-inter">
    ...
    <div class="container mx-auto my-8 px-4">
        <div class="bg-gray-800 p-8 rounded-lg shadow-md max-w-md mx-auto">
            ...
            <form action="add-category.html" method="POST">
                <div class="mb-6">
                    <label for="name" class="block text-gray-300">Category Name</label>
                    <input type="text" name="name" id="name" class="w-full p-3 bg-gray-700 border border-gray-600 rounded-lg text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 transition" required>
                </div>
                <button type="submit" class="bg-blue-600 hover:bg-blue-500 text-white p-3 rounded-lg transition-colors duration-200">Add Category</button>
            </form>
        </div>
    </div>
</body>
