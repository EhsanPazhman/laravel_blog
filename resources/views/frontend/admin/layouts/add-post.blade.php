        ...
        <div class="bg-gray-800 p-8 rounded-lg shadow-md max-w-2xl mx-auto">
            ...
            <form action="add-post.html" method="POST" enctype="multipart/form-data">
                <div class="mb-4">
                    ...
                    <input type="text" name="title" id="title" class="w-full p-3 bg-gray-700 border border-gray-600 rounded-lg text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 transition" required>
                </div>
                <div class="mb-4">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="content" id="content" class="w-full p-3 bg-gray-700 border border-gray-600 rounded-lg text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 transition" required></textarea>
                </div>
                <div class="mb-6">
                ...
                <button type="submit" class="bg-blue-600 hover:bg-blue-500 text-white p-3 rounded-lg transition-colors duration-200">Add Post</button>
            </form>
        </div>
    </div>
</body>
