        ...
        <div class="bg-gray-800 p-8 rounded-lg shadow-md max-w-md mx-auto">
            ...
            <form action="/login" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <input type="password" name="password" id="password" class="w-full p-3 bg-gray-700 border border-gray-600 rounded-lg text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 transition" required>
                </div>
                <button type="submit" class="bg-blue-600 hover:bg-blue-500 text-white p-3 rounded-lg w-full transition-colors duration-200">Login</button>
            </form>
        </div>
    </div>
 @endsection